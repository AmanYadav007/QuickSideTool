  ...
  return (
    <footer className="w-full bg-gradient-to-r from-[#1a1440]/90 via-[#1e215d]/90 to-[#2a1a4a]/90 text-white py-8 mt-16">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Logo */}
        <div className="text-2xl font-extrabold bg-gradient-to-r from-purple-400 via-blue-400 to-pink-400 bg-clip-text text-transparent tracking-wide mb-2 md:mb-0">
          Quick Side Tool
        </div>
        {/* Nav Links */}
        <div className="flex gap-6 text-white/80 text-base">
      ...
      <div className="mt-6 text-center text-xs text-white/60">
        &copy; {new Date().getFullYear()} Quick Side Tool. All rights reserved.
      </div>
    </footer>
  );
};
