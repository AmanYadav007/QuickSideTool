          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-10 animate-fade-in-down">
              ...
              <p className="text-white text-opacity-90 text-lg">
                Professional tools to enhance and optimize your images with ease.
              </p>
            </div>
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-xl animate-fade-in-up animation-delay-1000">
                <h3 className="text-xl font-bold text-white mb-3 text-transparent bg-clip-text bg-gradient-to-r from-blue-300 to-cyan-300">Features</h3>
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-xl animate-fade-in-up animation-delay-1200">
                <h3 className="text-xl font-bold text-white mb-3 text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-green-300">Supported Formats</h3>
                <ul className="space-y-2 text-white text-opacity-80 text-sm">
...
const ToolCard = ({ to, icon, title, description, gradientFrom, gradientTo }) => (
  ...
  >
    ...
    <div className={`absolute inset-0 rounded-xl border-2 border-transparent transition-all duration-300 ease-out 
    ...
    <div className="relative z-10 flex flex-col items-center">
      <div className={`w-16 h-16 mb-4 rounded-full flex items-center justify-center text-white shadow-lg
