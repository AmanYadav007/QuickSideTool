...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await submitForm(formData, formData.type);
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email Support",
      value: "support@quicksidetool.com",
    ...
    },
    {
      ...
      description: "Connect with other users and get real-time support",
      color: "text-purple-400",
      link: "https://discord.gg/5SufsJSj"
    },
    {
      icon: Globe,
      title: "Website",
      value: "quicksidetool.com",
      description: "Visit our main website for tools and resources",
  ...
  const submissionTypes = [
    {
      ...
      icon: MessageSquare,
      description: 'General questions, feedback, or support requests'
    },
    {
      value: 'feature-request',
      label: 'Feature Request',
      icon: Lightbulb,
      description: 'Suggest a new tool or feature you\'d like to see'
    },
    {
      value: 'bug-report',
      label: 'Bug Report',
  ...
  const faqs = [
    {
      ...
      answer: "Simply upload your PDF file, select the tool you want to use (merge, split, unlock, etc.), and follow the on-screen instructions. All processing happens in your browser for maximum privacy."
    },
    {
      question: "Are my files safe and private?",
      answer: "Absolutely! Your files never leave your device. All processing is done locally in your browser, ensuring complete privacy and security."
    },
    {
      question: "Do I need to create an account?",
      answer: "No account is required! All our tools are completely free to use without any registration or sign-up process."
    },
    {
      question: "What file formats are supported?",
      answer: "We support PDF files for all PDF tools, and JPG, PNG, WebP, GIF for image tools. QR codes can be exported in PNG, JPG, or SVG formats."
    },
    {
      question: "Is there a file size limit?",
      answer: "File size limits depend on your browser's capabilities. Generally, files up to 100MB work well, but larger files may take longer to process."
    },
    {
      question: "Can I use these tools for business purposes?",
      answer: "Yes! Our tools are perfect for both personal and business use. Many small businesses and freelancers rely on QuickSideTool for their daily document processing needs."
    }
  ];
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                    ...
                    <div className="space-y-3">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg hover:bg-purple-500/20 transition-all duration-200"
                      >
                        <MessageSquare className="w-5 h-5 text-purple-400" />
                        <div>
                          <div className="font-medium text-white">Discord Server</div>
                          <div className="text-sm text-gray-400">Get real-time support</div>
                        </div>
                      </a>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 p-3 bg-gray-500/10 border border-gray-500/20 rounded-lg hover:bg-gray-500/20 transition-all duration-200"
                      >
